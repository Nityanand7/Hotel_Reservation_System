...
urlpatterns = [
    ...
    path('administration/user/logout/',views.administration_logout,name='administration_logout'),
    path('administration/user/signup/', views.signup,name='administration_user_signup'),
    path('administration/user/login/', views.user_login,name='administration_user_login'),
